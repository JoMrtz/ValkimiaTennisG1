            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Ability = table.Column<int>(type: "int", maxLength: 3, nullable: false),
                    Strength = table.Column<int>(type: "int", maxLength: 3, nullable: true),
                    Speed = table.Column<int>(type: "int", maxLength: 3, nullable: true),
                    ReactionTime = table.Column<int>(type: "int", maxLength: 3, nullable: true),
